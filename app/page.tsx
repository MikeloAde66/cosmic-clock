...
export default function CosmicClockApp() {
  ...
  return (
    <main className="relative z-0 h-auto min-h-full overflow-visible md:min-h-dvh md:overflow-y-auto md:[-webkit-overflow-scrolling:touch] bg-slate-950 text-slate-100 flex flex-col justify-between gap-6 p-6 font-mono overflow-x-hidden touch-pan-y">
